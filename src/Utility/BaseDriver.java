...
public class BaseDriver {
    ...
    public static WebDriver driver;//her driver tanımlasın diye başa koyduk
    public static WebDriverWait wait;//ELEMENT ÇIKANA KADAR BEKLE
    ...
    public void Setup() {
        ...
        wait=new WebDriverWait(driver,Duration.ofSeconds(20));//ELEMENT ÇIKANA KADAR BEKLE
        LoginTest();
    }
